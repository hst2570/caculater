<template>
    <div class="textField">
        <input @input="checkMaxLength" :inputmode="inputmode" v-model="year" :type="type" maxlength="4"
            placeholder="2023" />.
        <input @input="checkMaxLength" ref="monthText" :inputmode="inputmode" v-model="month" :type="type" maxlength="2"
            placeholder="01" />.
        <input @input="checkMaxLength" ref="dayText" :inputmode="inputmode" v-model="day" :type="type" maxlength="2"
            placeholder="01" />
    </div>
</template>
<script setup>
